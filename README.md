...
교체할 위치는 `index.html`에서 `data-photo`로 검색하면 모두 찾을 수 있습니다 (총 15곳: 히어로 1 · 소개 1 · 갤러리 6 · 위치 1 · 주변 정보 5 · 예약 1).
...
예약 링크, 모든 한국어·영어 문구(143개 항목), 사진 15곳의 주소와 설명, 가격, 주소, 지도 링크까지 페이지의 거의 모든 내용을 섹션별로 정리해 보여줍니다. 줄바꿈은 Enter로 입력하면 홈페이지에도 그대로 반영됩니다.
